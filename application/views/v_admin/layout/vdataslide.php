            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>
                    <div>
                    <a onClick="confirm_modal('<?php echo base_url('webadmsekolah/slide/aksi/'.$row->IDSLIDE.'/'.$row->GAMBAR) ?>');" ><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
